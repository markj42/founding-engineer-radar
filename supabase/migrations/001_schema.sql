...
create index if not exists radar_events_created_idx on radar_events (created_at desc);
create index if not exists listings_kind_idx on listings (kind, seen_at desc);
